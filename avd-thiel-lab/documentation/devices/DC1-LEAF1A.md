...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.1.250/24 | 192.168.1.1 |
...
| Ethernet47 | P2P_LINK_TO_DC1-SPINE1_Ethernet47 | 1500 | routed | access | - | - | - | 10.0.0.1/31 | - | - |
...
interface Ethernet47
   description P2P_LINK_TO_DC1-SPINE1_Ethernet47
   no switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | Global Routing Table | 2.2.2.2/32 |
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| Tenant_A_APP_Zone | 1.1.1.2:12 | both 12:12 | learned | 130-131 |
| Tenant_A_WEB_Zone | 1.1.1.2:11 | both 11:11 | learned | 120-121 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| Tenant_A_APP_Zone | 1.1.1.2:12 | import 12:12<br> export 12:12 | connected |
| Tenant_A_WEB_Zone | 1.1.1.2:11 | import 11:11<br> export 11:11 | connected |
